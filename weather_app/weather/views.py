...
def home(request):
    if 'city' in request.GET:
        ...
        print(region,status,daytime)
        #return render(request,"home.html", {'region':region,'daytime':daytime})
        return JsonResponse({'region': region, 'daytime': daytime,'status':status},safe=False)
    else:
